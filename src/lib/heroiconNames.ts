// AUTO-GENERATED by scripts/build-heroicons-sprite.mjs — do not edit by hand.
// Run `npm run icons:build`. See ADR-052.
// HEROICON_NAMES: the 324 pickable Heroicon names (24px outline, https://heroicons.com).
// ICON_NAMES: every sprite symbol id (Heroicons + legacy iconoir-token aliases) — for validation.
export const HEROICON_NAMES: string[] = [
	'academic-cap',
