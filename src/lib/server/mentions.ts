...
// notifies people who were NEWLY mentioned (diffing against the prior text), are
// NOT the actor, and CAN access the project (so a hand-crafted person:<any-id>
// token can't notify or leak context to arbitrary users).
